...
export class OperatorsPlayersService {
  ...
  async leaderboard(dto: LeaderboardDto) {
    ...
    // prikaci osnovne info o playeru (email, displayName ako ima)
  ...
  // 2) Tabela igrača (list + sort + paginacija)
  ...
  // 3) Active players (distinct u prozoru)
